...
OnOffCells =  [5,6,12,23,24,31,33,36,39,43,];
OnCells = [1,2,3,4,7,9,11,13,14,16,17,20,21,22,25,27,28,29,30,35,38,40,42,];
badCells = [8,10,15,18,19,26,32,34,37,41,];
...
% [movie_name, path_name] = uigetfile('*.*');
...
% pathName = 'F:\Dropbox\DS project\8_Satb2\SummaryData\';
% MovieNameNoExt = movie_name(1:end-4);
...
% pathName = 'F:\Dropbox\DS project\3_compiledResults\Data\b2ko\';
% MovieNameNoExt = movie_name(1:end-4);
% save([pathName,MovieNameNoExt,'.mat'], 'roiInt', 'cellCenters', 'textFileArray')
...
% pathName = 'C:\Users\Olive\Dropbox\DS project\3_compiledResults\Data\EphKOs\';
% MovieNameNoExt = movie_name(1:end-4);
% save([pathName,MovieNameNoExt,'.mat'], 'roiInt', 'cellCenters', 'textFileArray')

%Karina Training
% pathName = 'F:\Dropbox\DS project\1a_DataShared\2_compiledResults\';
% MovieNameNoExt = movie_name(1:end-4);
% save([pathName,MovieNameNoExt,'.mat'], 'roiInt', 'cellCenters', 'textFileArray')


%Vglut2Cbln4
% pathName = 'F:\Dropbox\DS project\3_compiledResults\Data\vglut2Cbln4\';
% MovieNameNoExt = movie_name(1:end-4);
% save([pathName,MovieNameNoExt,'.mat'], 'roiInt', 'cellCenters', 'textFileArray')

% %Flrt2/Hb9
% pathName = 'F:\Dropbox\DS project\3_compiledResults\Data\flrt2\';
% MovieNameNoExt = movie_name(1:end-4);
% save([pathName,MovieNameNoExt,'.mat'], 'roiInt', 'cellCenters', 'textFileArray')
